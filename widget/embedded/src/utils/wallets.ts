...
import type { WalletInfo as ModalWalletInfo } from '@samo-dev/ui';
import type {
  Asset,
  Network,
  WalletInfo,
...
import { WalletState as WalletStatus } from '@samo-dev/ui';
import { readAccountAddress } from '@samo-dev/wallets-react';
import {
  detectInstallLink,
